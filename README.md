...
Также есть версия с использованием информационного метеоресурса `https://home.openweathermap.org`. Перед запуском программы Вам необходимо активировать API-ключ по ссылке `https://home.openweathermap.org/users/sign_in` и добавить его в константу `WEATHER_APP_ID` в `main.rb`, а также вписать в константу `CITY` название города.
## Установка и запуск:
